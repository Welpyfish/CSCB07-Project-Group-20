...
public class AddEditLocationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MaterialButton saveLocationButton = view.findViewById(R.id.save_location_button);
        MaterialButton cancelLocationButton = view.findViewById(R.id.cancel_location_button);
    ...
    private void saveLocation() {
        String address = Objects.requireNonNull(locationAddressEditText.getText()).toString().trim();
        String note = Objects.requireNonNull(locationNoteEditText.getText()).toString().trim();
