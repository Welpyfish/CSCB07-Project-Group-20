...
public class AddEditContactFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MaterialButton saveContactButton = view.findViewById(R.id.save_contact_button);
        MaterialButton cancelContactButton = view.findViewById(R.id.cancel_contact_button);
    ...
    private void saveContact() {
        String name = Objects.requireNonNull(contactNameEditText.getText()).toString().trim();
        String relationship = Objects.requireNonNull(relationshipEditText.getText()).toString().trim();
