...
public class SignInActivity extends AppCompatActivity implements SignInView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new SignInPresenter(this, new FirebaseAuthService(), userEmail, PinManager.doesPinExist(this));
    ...
    public String getPassword() {
        return Objects.requireNonNull(passwordEditText.getText()).toString().trim();
    }
