...
public class SignUpActivity extends AppCompatActivity implements SignUpView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new SignUpPresenter(this, new FirebaseAuthService(), PinManager.doesPinExist(this));
    ...
    public String getName() {
        return Objects.requireNonNull(nameEditText.getText()).toString();
    }

    @Override
    public String getPassword() {
        return Objects.requireNonNull(newPasswordEditText.getText()).toString();
    }
